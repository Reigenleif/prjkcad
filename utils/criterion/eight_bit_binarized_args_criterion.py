...
class EightBitBinarizedArgsCriterion(nn.Module):
    def __init__(self, lambda_args: float = 1.0):
        ...
        # Increased penalty for EOS, uncomment to enable
    ...
    def forward(self, cmd_logits, arg_logits, cmd_targets, arg_targets):
        ...
        # arg_logits shape: (B, T_pred, 31, 257)
        # arg_targets shape: (B, T_tgt, 31)
